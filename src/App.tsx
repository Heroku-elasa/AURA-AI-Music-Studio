...
import { performSemanticSearch, findLocalProviders, classifySearchQuery, GeminiApiError } from './services/geminiService';
...
const App: React.FC = () => {
  ...
  const handleApiError = (error: unknown): string => {
    ...
    if (error instanceof GeminiApiError) {
        ...
        // Fallback for non-Gemini errors or errors from other services
        message = error.message;
