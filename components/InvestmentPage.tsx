...
interface CollaborationLabelPageProps {
    setPage: (page: Page) => void;
}

const CollaborationLabelPage: React.FC<CollaborationLabelPageProps> = ({ setPage }) => {
    const { t } = useLanguage();
...
export default CollaborationLabelPage;
