...
const ConsultationDetailModal: React.FC<ConsultationDetailModalProps> = ({ isOpen, onClose, plan, onSave, handleApiError }) => {
  ...
  const handleGenerateAftercare = async () => {
    ...
    setAftercareError(null);
    try {
      // FIX: Property 'generateAftercare' does not exist on type 'typeof import("file:///services/geminiService")'.
  ...
  const handleCalculateCosts = async () => {
    ...
    setCostsError(null);
    try {
      // FIX: Property 'calculateTreatmentCosts' does not exist on type 'typeof import("file:///services/geminiService")'.
  ...
  const handleGeneratePrePlan = async () => {
    ...
    setPrePlanError(null);
    try {
      // FIX: Property 'generatePreTreatmentPlan' does not exist on type 'typeof import("file:///services/geminiService")'.
