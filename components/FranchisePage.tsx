...
interface StudioSetupPageProps {
...
const StudioSetupPage: React.FC<StudioSetupPageProps> = ({ setPage }) => {
    const { t } = useLanguage();
    const canvas: { [key: string]: { title: string, description: string } } = t('franchisePage.canvasItems');
